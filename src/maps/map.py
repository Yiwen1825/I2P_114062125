...
class Map:
    ...
    def check_collision(self, rect: pg.Rect) -> bool:
        ...
        '''
        for tile_rect in self._collision_map:
    ...
    def check_teleport(self, pos: Position) -> Teleport | None:
        ...
        for teleporter in self.teleporters:
            tp_x = teleporter.pos.x
            tp_y = teleporter.pos.y
            
            tp_rect = pg.Rect(tp_x, tp_y, GameSettings.TILE_SIZE, GameSettings.TILE_SIZE)
            
            player_rect = pg.Rect(pos.x, pos.y, 1, 1)
    ...
    def check_bush(self, pos: Position) -> bool:
        ...
        for bush_rect in self._bush_map:
            if bush_rect.colliderect(player_rect):
                return True
        return False
